...
class DateDifferenceExtractor(BaseEstimator, TransformerMixin):
    def __init__(self):
    ...
    def transform(self, X, y=None):
        df = X.copy()
        # Convert the 'ScheduledDay' and 'AppointmentDay' columns to datetime type
        ...
        # Select the 'date_difference' column to return
        df_transformed = df[['date_difference']]
        return df_transformed
