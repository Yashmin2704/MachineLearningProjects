...
def LogisticR(x_train,y_train,x_test,y_test):
    ...
    logr=LogisticRegression(fit_intercept=True,
                            **{'C': 0.05, 'class_weight': 'balanced', 'penalty': 'l2'},solver='liblinear')
...
def decision(x_train,y_train,x_test,y_test):
    ...
    '''random_search=RandomizedSearchCV(clf,cv=5,param_distributions=params,scoring='f1',n_iter=240,n_jobs=-1,verbose=20)
    dtree_fit=random_search.fit(x_train,y_train)
